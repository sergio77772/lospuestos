...
class Deactivate {
    ...
    public function setDeactivateReasons() {
        return require ( (__DIR__) . '/popup-assets/reasons.php' );
    }
...
class ControllerExtensionModuleElfsightPopup extends Controller {
    private $error = array();

    public $params = NULL;

    const ELFSIGHT_EMBED_URL = 'https://apps.elfsight.com/embed/popup/?utm_source=portals&utm_medium=opencart&utm_campaign=popup&utm_content=sign-up';

    public function index() {
        $this->load->language('extension/module/elfsight_popup');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_setting_setting->editSetting('module_elfsight_popup', $this->request->post);
        ...
        $data['action'] = $this->url->link('extension/module/elfsight_popup', 'user_token=' . $this->session->data['user_token'], true);
        ...
        $this->response->setOutput($this->load->view('extension/module/elfsight_popup', $data));
    }

    protected function validate() {
        if (!$this->user->hasPermission('modify', 'extension/module/elfsight_popup')) {
    ...
    public function setDeactivateReasons() {
        return require ( './controller/extension/module/popup-assets/reasons.php' );
    }
    ...
    public function uninstall() {
        ...
        include './controller/extension/module/popup-assets/popup.php';
    }
