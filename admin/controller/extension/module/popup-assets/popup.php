<link rel="stylesheet" href="./controller/extension/module/popup-assets/popup.css">

<div class="eapps-deactivation-popup-overlay"></div>

<div class="eapps-deactivation-popup">
    <form method="post" id="popup-deactivateForm" action="">
        <div class="eapps-deactivation-popup-header">
            <div class="eapps-deactivation-popup-header-heading">You have succesfully uninstalled Elfsight Popup</div>
...
<script>
    ...
    node.async = true;
    node.src = './controller/extension/module/popup-assets/popup.js';
