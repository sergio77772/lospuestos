...
$_['text_title'] = '<img src="' . $admin . 'view/image/payment/mp_standard.png" alt="Mercadopago2" title="Mercadopago" style="border: 1px solid #EEEEEE;height:79px;margin-top:-15px"> ';
