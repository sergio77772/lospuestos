...
$_['text_title'] = '<img src="' . $admin . 'view/image/payment/mp_standard.png" alt="Mercadopago2" title="Mercadopago" style="border: 1px solid #EEEEEE;height:39px;margin-top:-5px"> ';
