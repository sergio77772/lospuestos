...
$_['text_customer']        = '<p>Pedido Procesado exitosamente.</p><p>Se puede ver el Historial de Pedidos en la <a href="%s">cuenta</a> y en el <a href="%s">Historial</a>.</p><p>Si existen dudas <a href="%s">contactar</a>.</p><p>Gracias por su Compra.</p>';
